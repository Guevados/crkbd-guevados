...
TD(TD_CAPLOCK) ,   KC_Z   ,   KC_X   ,   KC_C   ,   KC_V   ,   KC_B   ,               KC_N   ,   KC_M   ,TD(TD_COMM),TD(TD_DOT),TD(TD_SLA), KC_ESC  ,
  //-----------+----------+----------+----------+----------+--------------|  |---------------+----------+----------+----------+----------+----------|
                                      KC_LGUI,   LOWER,   KC_SPC,        RSFT_T(KC_ENT),    RAISE, RALT_T(KC_LALT)
                                    //|-----------------------------------|  |-----------------------------------|
  ),
  ...
  //|----------+----------+----------+----------+----------+----------|           |----------+----------+----------+----------+----------+----------|
      KC_TAB   , XXXXXXX  , XXXXXXX  , XXXXXXX  , KC_VOLU  , KC_MUTE  ,              KC_LEFT , KC_DOWN  ,  KC_UP   , KC_RGHT  , XXXXXXX  , XXXXXXX  ,
  //|----------+----------+----------+----------+----------+----------|           |----------+----------+----------+----------+----------+----------|
      KC_LSFT  , XXXXXXX  , XXXXXXX , KC_MPRV   , KC_VOLD  , KC_MNXT  ,             TERM_TOG , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  ,
  //-----------+----------+----------+----------+----------+--------------|  |---------------+----------+----------+----------+----------+----------|
  ...
  [_RAISE] = LAYOUT(
  //|-----------------------------------------------------------------|           |-----------------------------------------------------------------|
      KC_ESC   , KC_EXLM  ,  KC_AT   , KC_HASH  ,  KC_DLR  , KC_PERC  ,              KC_CIRC , KC_AMPR  , KC_ASTR  ,TD(TD_PRN), XXXXXXX  ,  KC_BSPC ,
  //|----------+----------+----------+----------+----------+----------|           |----------+----------+----------+----------+----------+----------|
  ...
  //|----------+----------+----------+----------+----------+----------|           |----------+----------+----------+----------+----------+----------|
      RGB_MOD  , RGB_HUI  , RGB_SAI  , RGB_VAI  , RGB_SPI  ,  RGBRST  ,             XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  ,\
  //|----------+----------+----------+----------+----------+----------|           |----------+----------+----------+----------+----------+----------|
      RGB_TOG  , RGB_HUD  , RGB_SAD  , RGB_VAD  , RGB_SPD  , XXXXXXX  ,             XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  ,   RESET  ,\
  //-----------+----------+----------+----------+----------+--------------|  |---------------+----------+----------+----------+----------+----------|
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (keycode) {
    ...
    case ADJUST:
      ...
      case TERM_TOG:
        if (record->event.pressed) {
          SEND_STRING(SS_DOWN(X_LALT) SS_DOWN(X_3));
        } else {
          clear_keyboard();
        }
        return false;
